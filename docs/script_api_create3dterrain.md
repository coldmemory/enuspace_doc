...
스크립트를 이용하여 동적으로 Terrain 객체를 생성합니다. 생성된 객체의 속성을 변경하고자 하는 경우에는 [SetAttribute3D\(\)](https://expnuni.github.io/enuspace_doc/docs/enusscriptapi_setattribute3d/)함수를 이용합니다.
